            ...
            <div className="max-w-7xl mx-auto px-4 py-16">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
                    ...
                    <div>
                        ...
                        <ul className="space-y-3 text-sm">
                            ...
                            <li><Link to="/projects" className="hover:text-blue-400 transition-colors flex items-center gap-2">Projet de Société</Link></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3 text-sm">
                            ...
                            <li><Link to="/volunteer" className="hover:text-blue-400 transition-colors">Devenir Bénévole</Link></li>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3 text-sm">
                            ...
                            <li><Link to="/transparency" className="hover:text-blue-400 transition-colors">Rapports d'activité</Link></li>
                        </ul>
                    </div>
                </div>
                ...
                <div className="border-t border-slate-800 mt-16 pt-8 flex flex-col md:flex-row justify-between items-center text-[10px] uppercase tracking-widest text-slate-500 font-medium">
                    ...
                    <div className="mt-4 md:mt-0 flex items-center gap-6">
                        ...
                        <span className="text-blue-500">Réalisé en interne</span>
                    </div>
                </div>
            </div>
        </footer>
